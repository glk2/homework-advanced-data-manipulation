...
public class Room {
    ...
    @Max(message = "Wrong max value", value = 999)
    @Min(message = "Wrong min value", value = 100)
    @InstanceName
    @NotNull
    @Column(name = "NUMBER_", nullable = false)
    private Integer number;

    @Max(message = "Wrong max floor", value = 9)
    @Min(message = "Wrong min floor", value = 1)
    @Column(name = "FLOOR_")
    private Integer floor;

    @Positive(message = "Wrong negative value")
